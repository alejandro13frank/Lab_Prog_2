    ...
    public partial class FrmSistemaSolar : Form
    {
        ...
        private void btnSimular_Click(object sender, EventArgs e)
        {
            if(this.animaciones.Count == 0)
            {
                ...
                this.Text = estado.EstadoSimulation(false) + " Alejandro frank";
            }
            else
            {
                string estado="";
                ...
                this.Text = estado.EstadoSimulation(true)+" Alejandro frank";
            }
        }
        ...
        private void DibujarAvancePlaneta(object sender, PlanetaEventArgs e)
        {
            ...
            {
                InformacionDeAvance informacionDeAvance = new InformacionDeAvance(this.DibujarAvancePlaneta);
                this.Invoke(informacionDeAvance, new object[] {sender, e});
            }
            else
            {
